...
import (
	...
	"github.com/upbound/provider-dummy/apis"
	"github.com/upbound/provider-dummy/apis/v1alpha1"
	dummy "github.com/upbound/provider-dummy/internal/controller"
	"github.com/upbound/provider-dummy/internal/controller/features"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Dummy support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Dummy APIs to scheme")
	...
	kingpin.FatalIfError(dummy.Setup(mgr, o), "Cannot setup Dummy controllers")
